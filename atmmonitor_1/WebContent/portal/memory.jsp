		...
		<div class="content">
		 ...
		 <div class="scroll_div" id="center">                           
			  <table class="tableborder" id="tab">
					<tr>
						<th><!--<eoms:lable name="sm_lb_totalMemory"/>-->总内存</th>
						<th><!--<eoms:lable name="sm_lb_usedMemory"/>-->使用内存</th>
						<th><!--<eoms:lable name="sm_lb_percentUsed"/>-->使用百分比</th>
						<th><!--<eoms:lable name="sm_lb_percentFree"/>-->空闲百分比</th>
					</tr>
					<tr>
