...
<html>
                			...
                			<div class="rightDiv" style="margin: 0 auto; width:100%;">	                			
								...
								<div class="searchInfo">
	                				...
	                				<c:set var="roleid" value="0"/>
		                             ...
		                             <input type="button" class="transparentBtn" onclick="openBsRole('@@{id}','@@{status}')" value="审批" />
  ...
  <script type="text/javascript">
	...
	function preFunc(paraStr)
	{
		...
		paraStr.approver_condition=loginname;
		paraStr.status_condition=1;
	...
	{ 
		...
		layer.open({           
            ...
            area: ['900px', '450px'], 
            content: '${ctx}/equipmentchange/equipmentChangeApproveDetail.action?pid='+roleid
