                			...
                			<div class="rightDiv" style="margin: 0 auto; width:100%;">	                			
								...
								<div class="searchInfo">
	                				...
	                				<c:set var="roleid" value="0"/>
		                             ...
		                             <input type="button" class="transparentBtn" onclick="openBsRole('@@{id}','@@{status}')" value="处理" />
...
　　                                                                                        <!--</c:if>-->
  ...
  <script type="text/javascript">
	...
	function preFunc(paraStr)
	{
		...
		paraStr.maintainer_condition=loginname;
		paraStr.status_condition=2;
	...
	{ 
		...
		layer.open({           
            ...
            title: ['处理维修单', 'font-size:14px;color:#333333;text-align:left;'],//弹窗标题的内容及对应样式
            area: ['900px', '550px'], 
            content: '${ctx}/equipmentchange/equipmentChangeMaintainDetail.action?pid='+roleid
