package com.common.core.component.rquery;
...
import com.common.core.component.data.QueryAdapter;
import com.common.core.component.rquery.core.SqlQuery;
	...
	public String getJsonString()
	{
		...
		if(sqlQuery!=null)
		{
			...
			if(sqlResult!=null)
			{
				...
				QueryAdapter queryAdapter=new QueryAdapter(dbpoolname,dbType);
				result=queryAdapter.executeQueryForJson(sqlResult.getSql(), values, this.getPage(), this.getPageSize(), this.getIsCount());
