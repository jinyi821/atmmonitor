...
public abstract class ConverterWord {
    ...
    public ConverterWord(InputStream inStream, OutputStream outStream, boolean showMessages, boolean closeStreamsWhenComplete){ 
