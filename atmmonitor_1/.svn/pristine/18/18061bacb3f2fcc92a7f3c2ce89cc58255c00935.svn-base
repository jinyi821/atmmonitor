...
<body>
 <div class="divsection">             
	...
	<form action="${ctx}/equipmentchange/saveEquipmentMaintain.action" method="post"   name="myform" id="myform" target="_parent">
         ...
         <table class="base_table fontSize3 ContentTable">
          <tbody class="table_body">
		   ...
		   <tr>
				...
				<td colspan="3">
			        <textarea id="maintainremark" name="maintainremark"  class="textAreaSy" style="width:95%;" placeholder="建议不要超过100字">${equipmentChange.maintainremark}</textarea>
			    </td>			     
		   </tr>
		...
		<div class="base3">
		    <c:if test="${equipmentChange.status ==2 }">
