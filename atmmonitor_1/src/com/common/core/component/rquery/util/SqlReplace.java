package com.common.core.component.rquery.util;

import java.util.ArrayList;
import java.util.HashMap;
import java.util.List;

import com.common.core.component.rquery.core.CustWhere;
import com.common.core.component.rquery.core.NextVar;
import com.common.core.component.rquery.core.SqlResult;
import com.common.core.util.ArrayTransferUtils;
...
//	    	    	value=StringUtils.checkNullString(com.ultrapower.remedy4j.core.RemedySession.UtilInfor.getTableName(varName));
	...
	public static String getSystemVar(final String varName)
	{
		...
		else if(SystemVar.CURRENT_KGPID.equals(var))
		{
			result=userSession.getKgpid();
		}		
		*/
		return result;
	}
