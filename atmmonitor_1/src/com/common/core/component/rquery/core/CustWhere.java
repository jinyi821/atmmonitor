...
import com.common.core.component.rquery.datatransfer.DataTransfer;
...
import com.common.core.component.rule.RuleExpression;
...
//			values=SqlReplace.stringReplaceAllVar(values, this.indirectValues,RConstants.DATA_VAR_SYSTEM);			
		...
		{
			int dayint=TimeUtils.dayToInt(values);
			if(dayint>0)
			{
				values=StringUtils.checkNullString(TimeUtils.dayToInt(values));
			}
		}
