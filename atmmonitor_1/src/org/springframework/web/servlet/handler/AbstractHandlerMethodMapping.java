/*
 * 
 *  jinyi add 526 到 532 行 ，把所有control链接地址放到缓存 ，请不要删除
 * 
 * 
		...
		public void register(T mapping, Object handler, Method method) {
			...
			try {
				...
				if (logger.isInfoEnabled()) {
					...
					/**
					 *  jinyi add  把所有control链接地址放到缓存
					 */
					String mappingS=mapping.toString();
					
					int indexOf1 = mappingS.indexOf("{[");
					int indexOf2 = mappingS.indexOf("]");
					String substring = mappingS.substring(indexOf1+3, indexOf2);
					
					/*InitBsLink.setMappingS(substring,handlerMethod.toString());*/
					String aa=handlerMethod.toString();
