...
public class DcsFailureFile  implements java.io.Serializable
{
    //DCS失败文件
    private static final long serialVersionUID = 1L;

    private Integer file_id; //文件id
    private Integer ftp_id; //ftp表id
    private Integer data_type_id; //数据类型id
    private String path_and_name; //文件保存路径和名称
    private String rename_file_name; //文件更改后的名称
    ...
    public Long getTo_hdfs_duration() {
        return to_hdfs_duration;
    }

    public void setTo_hdfs_duration(Long to_hdfs_duration) {
        this.to_hdfs_duration = to_hdfs_duration;
    }
