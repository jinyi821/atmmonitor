                            ...
                            <div class="dt-toolbar">
                                ...
                                <div class="col-xs-11 col-sm-11">
                                    <div id="dt_basic_filter" class="dataTables_filter">
                                        ...
                                        <#---->
                                        <#--</span>-->
                                            <form id="searchForm" method="post" style="display:inline-block;">
                                                <select id ="ftpId"
                                            ...
                                            <div class="form-group">
                                                ...
                                                <#--<input id="timeRange" type='text' style="width:210px" class="form-control " placeholder="请输入开始时间和结束时间"/>-->
                                                    <input type="text" name="startdate" id="startdate" style="width:100px" class="form-control " placeholder="日期起">
                                                    <span class="input-group-addon ">
                                                    <span class="glyphicon glyphicon-calendar"></span>
                                                    </span>
                                                    <input type="text" style="width:100px" name="finishdate" id="finishdate" class="form-control " placeholder="日期止">
...
<script>
    ...
    function goto(pn) {
        ...
        $("#content").load(BASE_PATH + "/historyFiles/",
                {
                    pn: pn,
                    ftpId:ftpId,
